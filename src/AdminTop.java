...
public class AdminTop extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton8.setText("View Never Taken Items");
        jButton8.setMaximumSize(new java.awt.Dimension(171, 39));
        jButton8.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton8ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 510, 410, 40));
