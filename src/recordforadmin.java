...
public class recordforadmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        record.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SerailNo", "DonorId", "NeedyId", "ProductId", "ProductName", "Quantity", "Unit"
            }
        ));
        ...
        getContentPane().add(pid, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 240, 100, 30));
        ...
        getContentPane().add(enterpid, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 240, 160, 30));
 ...
 // TODO add your handling code here:
    ...
    private void showTransactionsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showTransactionsActionPerformed
        ...
        try {
            ...
            Statement statement = connection.createStatement();
            ResultSet rs = statement
                    .executeQuery("select d.D_id,d.D_name ,N.N_id,N.N_name,N.N_annualincome,r.R_productName from DonorDetails d inner join records r\n" +
