...
public class SearchProduct extends javax.swing.JFrame {
 String u,a,e;
    ...
    private void initComponents() {
        ...
        productComb.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Electronics", "Food", "Groceries", "Furniture", "Electronics and Food", "Electronics and Groceries", "Electronics and Furniture", "Food and Groceries", "" }));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 320, 1110, 310));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 20, 140, -1));
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -10, 1120, 530));
