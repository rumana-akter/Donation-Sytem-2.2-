...

            {
                ...
                if (value.equals("DONATIONS")) {
                    ...
                    try {
                        ...
                        String sql = "SELECT MAX (DATENAME(MM,dateofdonation)) AS MONTHNAMES,COUNT (DATENAME(MM,dateofdonation)) AS NO_OF_EMPLOYEES FROM DONATIONTABLE GROUP BY MONTH(dateofdonation) order by NO_OF_EMPLOYEES DESC";
                    ...
                    try {
                        ...
                        String sql = "SELECT MAX (DATENAME(MM,DonationDate)) AS MONTHNAMES,COUNT (DATENAME(MM,DonationDate)) AS NO_OF_EMPLOYEES FROM RECORDS GROUP BY MONTH(DonationDate) order by NO_OF_EMPLOYEES DESC";
                    ...
                    try {
                        ...
                        String sql = "SELECT MAX (DATENAME(MM,requestdate)) AS MONTHNAMES,COUNT (DATENAME(MM,requestdate)) AS NO_OF_EMPLOYEES FROM request GROUP BY MONTH(requestdate) order by NO_OF_EMPLOYEES DESC";
...

            {
                ...
                if (value.equals("DONATIONS")) {
                    ...
                    try {
                        ...
                        String sql = "SELECT MAX (DATENAME(MM,dateofdonation)) AS MONTHNAMES,COUNT (DATENAME(MM,dateofdonation)) AS NO_OF_EMPLOYEES FROM DONATIONTABLE GROUP BY MONTH(dateofdonation) order by MONTH(dateofdonation)";
